...
[test_public_config_pipeline.py](../../../../tests/visual_annotation/e2e/public_boundary/test_public_config_pipeline.py)
runs the public config lifecycle through `visual_annotation`.
